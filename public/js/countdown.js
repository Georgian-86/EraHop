class TimeWarpCountdown {
    ...
    updateCountdown() {
        ...
        if (this.countdownElement) {
            this.countdownElement.innerHTML = this.getMainCountdownHTML(days, hours, minutes, seconds);
        }

        // Update mini countdown
        if (this.miniCountdownElement) {
            this.miniCountdownElement.innerHTML = this.getMiniCountdownHTML(days, hours, minutes, seconds);
        }
    }
    ...
    getMiniCountdownHTML(days, hours, minutes, seconds) {
        return `
            ...
            <span class="countdown-label">until Time Fest 2024</span>
        `;
    }
} 