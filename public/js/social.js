class SocialFeed {
        ...
        this.posts = [
            {
                ...
                content: 'Just visited the prehistoric era! #TimeFest2024',
        ...
        return `
            <div class="social-post ${post.platform}">
                <div class="post-header">
                    <img src="/images/avatars/default.png" alt="${post.username}" class="avatar">
                    <span class="username">${post.username}</span>
                </div>
                ${post.image ? `<img src="${post.image}" alt="Post image" class="post-image">` : ''}
                <p class="post-content">${post.content}</p>
                <div class="post-footer">
                    <button class="like-button" onclick="socialFeed.likePost(${post.id})">
    ...
    share(platform) {
        const text = `Join me at Time Fest 2024! #${this.hashtag}`;
